...
var render = function() {
  ...
  return _c("div", { staticClass: "columns is-multiline" }, [
    _c(
      ...
      _vm._l(_vm.counter, function(count) {
        return _c("NewsCard", {
          key: count,
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "column is-one-third" }, [
      ...
      _c(
        "div",
        { staticStyle: { height: "60px", border: "solid 1px white" } },
        [
          _c(
            "div",
            {
          ...
          _c("div", { staticStyle: { padding: "10px" } }, [
            _c(
              "progress",
              { staticClass: "progress", attrs: { value: "15", max: "100" } },
              [_vm._v("15%")]
            )
          ])
        ]

        ...
        <transition name="fade">
            ...
            <div v-else class="" key="2">
                ...
                <div class="columns is-marginless">
                    <div class="column" @click="{ loadgame(510699); activetab = 0; }" :class="{'active' : activetab === 0}">APOC</div>
                    <div class="column" @click="{ loadgame(138585); activetab = 1; }" :class="{'active' : activetab === 1}">Ashes of Creation</div>
                    <div class="column" @click="{ loadguild(); activetab = 2; }" :class="{'active' : activetab === 2}">Guild</div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadgame: function(gameid) {
                axios.get('/api/twitchdata/' + gameid)
                    .then(({data}) => this.twitchdata = data );
            },
            loadguild: function() {
                axios.get('/api/twitchuser/arustedknight')
                    .then(({data}) => this.twitchdata = data );
            }
        },
        created() {
